            ...
            'select
                        ...
                        join languages on sura_langs.language_id = languages.id
                         join sura_reciters on sura_langs.sura = sura_reciters.sura
                          join suras on sura_langs.sura = suras.sura and sura_langs.ayah = suras.ayah where sura_langs.language_id = ? and sura_reciters.reciter_id = ?
        ...
        return DB::select(
            'select
                        ...
                        CONCAT(?,"/storage/",sura_reciters.audio) as audio
                         from sura_langs
                          join sura_reciters on sura_langs.sura = sura_reciters.sura
                            join suras on sura_langs.sura = suras.sura and sura_langs.ayah = suras.ayah where sura_langs.sura = ? and sura_langs.language_id = ?',

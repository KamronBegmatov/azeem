...
<div class="create row">
    <div class="col-12">
        <form class="fill-form" method="POST" action="{{ url('reciters') }}">
            @csrf
        {{--    <div class="row g-3 align-items-center">
                ...
                <div class="col-8">
                    <input type="text" name="title" id="inputPassword1" class="form-control">
                </div>
            </div>--}}
            <div class="row g-3 align-items-center">
                <div class="col-4">
                ...
                <div class="col-8">
                    <input type="file" name="image" id="inputPassword2" class="form-control">
                </div>
            </div>
            <div class="row g-3">

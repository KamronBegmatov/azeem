    ...
    <div class="row g-3 align-items-center">
        ...
        <div class="col-8">
            <input type="number" name="active" id="inputPassword6" class="form-control"
                aria-describedby="passwordHelpInline" value="{{ $allah_name->active }}">
        </div>
    </div>
    <div class="row g-3 align-items-center">
        <div class="col-4">
        ...
        <div class="col-8">
            <input type="text" name="iso-code" id="inputPassword6" class="form-control"
                aria-describedby="passwordHelpInline" value="{{ $allah_name->iso_code }}">
        </div>
    </div>
    <div class="row g-3 align-items-center">
        <div class="col-4">
        ...
        <div class="col-8">
            <input type="text" name="allah_name-code" id="inputPassword6" class="form-control"
                aria-describedby="passwordHelpInline" value="{{ $allah_name->allah_name_code }}">
        </div>
    </div>
    <div class="row g-3">
